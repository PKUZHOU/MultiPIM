...
void list_insert_item_head(list_t *l,
						   list_item_t *i)
{
	if (l->head)
	{
...
void list_insert_item_tail(list_t *l,
						   list_item_t *i)
{
	if (l->head)
	{
...
void list_insert_item_sorted(list_t *l,
							 list_item_t *i)
{
	list_item_t *itr;
...
void list_insert_after(list_t *l,
					   list_item_t *pred,
					   void *v)
{
	list_item_t *i;
...
void list_insert_sorted(list_t *l,
						void *v)
{
	list_item_t *itr;
	list_item_t *i;
...
void list_remove_item(list_t *l,
					  list_item_t *i)
{
	if (i == l->head)
	{
...
void list_visit_items(list_t *l,
					  void (*visitor)(void *v))
{
	list_item_t *li;
...
void list_item_init(list_item_t *li,
					void *datum)
{
...
void list_iterator_init(list_t *l,
						list_iterator_t *li)
{
	*li = l ? l->head : NULL;
}
...
long transform_to_cuda(node *root,
					   bool verbose)
{
